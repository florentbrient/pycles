...
subroutine lw_kgb01
	...
	integer(kind=4) :: ab
	integer(kind=4), parameter :: bandNumber = 1, numGPoints = no1
	integer(kind=4), parameter :: gPointSetNumber = 1
...
subroutine lw_kgb02
	...
	use netcdf
   	...
   	integer(kind=4), parameter :: bandNumber = 2
	integer(kind=4), parameter :: numGPoints = no2
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb03
	...
	integer(kind=4) :: ab
        integer(kind=4), parameter :: bandNumber = 3
	integer(kind=4), parameter :: numGPoints = no3
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb04
	...
	use netcdf
        ...
        integer(kind=4), parameter :: bandNumber = 4
	integer(kind=4), parameter :: numGPoints = no4
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb05
	...
	use netcdf
        ...
        integer(kind=4) :: ab
        integer(kind=4), parameter :: bandNumber = 5
	integer(kind=4), parameter :: numGPoints = no5
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb06
	...
	integer(kind=4) :: ab
        integer(kind=4), parameter :: bandNumber = 6
	integer(kind=4), parameter :: numGPoints = no6
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb07	
	...
	use netcdf
        ...
        integer(kind=4) :: ab
   	integer(kind=4), parameter :: bandNumber = 7
	integer(kind=4), parameter :: numGPoints = no7
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb08		
	...
	use netcdf
        ...
        integer(kind=4) :: ab
        integer(kind=4), parameter :: bandNumber = 8
	integer(kind=4), parameter :: numGPoints = no8
        integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb09	
	...
	use netcdf
        ...
        integer(kind=4) :: ab
        integer(kind=4), parameter :: bandNumber = 9
	integer(kind=4), parameter :: numGPoints = no9
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb10		
	...
	use netcdf
   	...
   	integer(kind=4), parameter :: bandNumber = 10
	integer(kind=4), parameter :: numGPoints = no10
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb11
	...
	integer(kind=4) :: ab
	integer(kind=4), parameter :: bandNumber = 11
	integer(kind=4), parameter :: numGPoints = no11
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb12
	...
	integer(kind=4), parameter :: bandNumber = 12
	integer(kind=4), parameter :: numGPoints = no12
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb13		
	...
	use netcdf
        ...
        integer(kind=4) :: ab
	integer(kind=4), parameter :: bandNumber = 13
	integer(kind=4), parameter :: numGPoints = no13  
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb14	
	...
	integer(kind=4), parameter :: bandNumber = 14
	integer(kind=4), parameter :: numGPoints = no14
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb15	
	...
	use netcdf
        ...
        integer(kind=4) :: ab
 	integer(kind=4), parameter :: bandNumber = 15
	integer(kind=4), parameter :: numGPoints = no15
	integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
...
subroutine lw_kgb16		
	...
	use netcdf
        ...
        integer(kind=4), parameter :: bandNumber = 16
 	integer(kind=4), parameter :: numGPoints = no16
        integer(kind=4), parameter :: gPointSetNumber = 1
	integer(kind=4) :: ncid, varID
