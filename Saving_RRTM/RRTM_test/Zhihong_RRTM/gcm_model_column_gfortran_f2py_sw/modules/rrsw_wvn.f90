...
!------------------------------------------------------------------
      ...
      integer(kind=4) :: ng(jpb1:jpb2)
      integer(kind=4) :: nspa(jpb1:jpb2)
      integer(kind=4) :: nspb(jpb1:jpb2)

      real(kind=8) :: wavenum1(jpb1:jpb2)
      real(kind=8) :: wavenum2(jpb1:jpb2)
      real(kind=8) :: delwave(jpb1:jpb2)

      integer(kind=4) :: ngc(nbndsw)
      integer(kind=4) :: ngs(nbndsw)
      integer(kind=4) :: ngn(ngptsw)
      integer(kind=4) :: ngb(ngptsw)
      integer(kind=4) :: ngm(nbndsw*mg)

      real(kind=8) :: wt(mg)
      real(kind=8) :: rwgt(nbndsw*mg)
