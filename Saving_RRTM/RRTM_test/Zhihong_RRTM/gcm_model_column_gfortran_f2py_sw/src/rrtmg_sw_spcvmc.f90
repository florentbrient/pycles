...
! ------- Input -------
      ...
      real(kind=8), intent(in) :: pcldfmc(nlayers,ngptsw)                ! cloud fraction [mcica]
                                                               !   Dimensions: (nlayers,ngptsw)
      real(kind=8), intent(in) :: ptaucmc(nlayers,ngptsw)                ! cloud optical depth [mcica]
                                                               !   Dimensions: (nlayers,ngptsw)
      real(kind=8), intent(in) :: pasycmc(nlayers,ngptsw)                ! cloud asymmetry parameter [mcica]
                                                               !   Dimensions: (nlayers,ngptsw)
      real(kind=8), intent(in) :: pomgcmc(nlayers,ngptsw)                ! cloud single scattering albedo [mcica]
                                                               !   Dimensions: (nlayers,ngptsw)
      real(kind=8), intent(in) :: ptaormc(nlayers,ngptsw)                ! cloud optical depth, non-delta scaled [mcica]
                                                               !   Dimensions: (nlayers,ngptsw)
