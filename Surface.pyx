...
cdef class SurfaceVARF:
    def __init__(self,namelist):
        ...
        self.qt_flux       = namelist['thermo']['qt_flux'] # m/s
        self.ustar_ = 0.28 #m/s
        self.theta_surface = namelist['thermo']['theta_surface'] #K
        self.qt_surface    = namelist['thermo']['qt_surface'] # kg/kg
...
cdef class SurfaceVARRico:
    def __init__(self,namelist):
        self.cm = namelist['thermo']['cm']
        self.ch = namelist['thermo']['ch']
        self.cq = namelist['thermo']['cq']
        self.z0 = 0.00015
        self.gustiness = 0.0
        return
