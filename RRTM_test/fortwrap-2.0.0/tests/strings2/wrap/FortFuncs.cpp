...
void FortFuncs::string_out_literal_len(FortranString *s) {
  // Declare memory to store output character data
  char s_c__[20+1];
  s_c__[20] = '\0';
  __strings2_MOD_string_out_literal_len(s ? s_c__ : NULL, 20);
  if (s) {
...
void FortFuncs::string_out_literal_len2(FortranString *s) {
  // Declare memory to store output character data
  char s_c__[8+1];
  s_c__[8] = '\0';
  __strings2_MOD_string_out_literal_len2(s ? s_c__ : NULL, 8);
  if (s) {
    // Trim trailing whitespace and assign character array to string:
...
void FortFuncs::string_out_param_len(FortranString *s1, FortranString *s2, FortranString *s3, FortranString *s4) {
  // Declare memory to store output character data
  char s3_c__[20+1];
  s3_c__[20] = '\0';
  // Declare memory to store output character data
  ...
  char s4_c__[20+1];
  s4_c__[20] = '\0';
  __strings2_MOD_string_out_param_len(s1 ? s1_c__ : NULL, s2 ? s2_c__ : NULL, s3 ? s3_c__ : NULL, s4 ? s4_c__ : NULL, 20, 20, 20, 20);
  if (s3) {
    // Trim trailing whitespace and assign character array to string:
...
void FortFuncs::string_out_param_len2(FortranString *s1, FortranString *s2, FortranString *s3, FortranString *s4) {
  // Declare memory to store output character data
  char s3_c__[20+1];
  s3_c__[20] = '\0';
  // Declare memory to store output character data
  ...
  char s4_c__[20+1];
  s4_c__[20] = '\0';
  __strings2_MOD_string_out_param_len2(s1 ? s1_c__ : NULL, s2 ? s2_c__ : NULL, s3 ? s3_c__ : NULL, s4 ? s4_c__ : NULL, 20, 20, 20, 20);
  if (s3) {
    // Trim trailing whitespace and assign character array to string:
    for (int i=20-1; s3_c__[i]==' '; i--) s3_c__[i] = '\0';
    s3->assign(s3_c__);
...
void FortFuncs::string_out_assumed_len(FortranString *s1, int x, FortranString *s2) {
  int s2_len__ = 0;
  ...
  s1_c__[s1_len__] = '\0';
  __strings2_MOD_string_out_assumed_len(s1 ? s1_c__ : NULL, &x, s2 ? s2_c__ : NULL, s1_len__, s2_len__);
  if (s2) {
    // Trim trailing whitespace and assign character array to string:
...
int FortFuncs::string_in_test(const char* s) {
  ...
  return __strings2_MOD_string_in_test(s ? s_c__ : NULL, 20);
}
...
int FortFuncs::string_in_cutoff(const char* s) {
  ...
  return __strings2_MOD_string_in_cutoff(s ? s_c__ : NULL, 6);
}
...
int FortFuncs::string_in_assumed_len(const char* s1, int x, const char* s2) {
  ...
  return __strings2_MOD_string_in_assumed_len(s1, &x, s2, s1_len__, s2_len__);
}

void FortFuncs::multiple_args(int dumint, const char* s1, float dumfloat, FortranString *s2) {
  // Declare memory to store output character data
  char s2_c__[20+1];
  s2_c__[20] = '\0';
  // Create C array for Fortran input string data
  ...
  __strings2_MOD_multiple_args(&dumint, s1 ? s1_c__ : NULL, &dumfloat, s2 ? s2_c__ : NULL, 20, 20);
  if (s2) {
    // Trim trailing whitespace and assign character array to string:
    for (int i=20-1; s2_c__[i]==' '; i--) s2_c__[i] = '\0';
    s2->assign(s2_c__);
...
int FortFuncs::optional_in(const char* s) {
  ...
  return __strings2_MOD_optional_in(s ? s_c__ : NULL, 20);
}

int FortFuncs::optional_in_assumed(const char* s) {
  int s_len__ = 0;
  if (s) s_len__ = strlen(s); // Protect Optional args
  return __strings2_MOD_optional_in_assumed(s, s_len__);
}

int FortFuncs::optional_out(FortranString *s) {
  // Declare memory to store output character data
  char s_c__[20+1];
  s_c__[20] = '\0';
  int __retval = __strings2_MOD_optional_out(s ? s_c__ : NULL, 20);
  if (s) {
    // Trim trailing whitespace and assign character array to string:
    for (int i=20-1; s_c__[i]==' '; i--) s_c__[i] = '\0';
    s->assign(s_c__);
...
int FortFuncs::optional_out_assumed(FortranString *s) {
  int s_len__ = 0;
  if (s) s_len__ = s->length();
  // Declare memory to store output character data
  char s_c__[s_len__+1];
  s_c__[s_len__] = '\0';
  int __retval = __strings2_MOD_optional_out_assumed(s ? s_c__ : NULL, s_len__);
  if (s) {
    // Trim trailing whitespace and assign character array to string:
