...
!------------------------------------------------------------------
      ...
      real(kind=8) :: fluxfac, heatfac
      real(kind=8) :: oneminus, pi, grav
      real(kind=8) :: planck, boltz, clight
      real(kind=8) :: avogad, alosmt, gascon
      real(kind=8) :: radcn1, radcn2
      real(kind=8) :: sbcnst, secdy
